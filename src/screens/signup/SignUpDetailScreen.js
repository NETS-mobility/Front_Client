...
const SignUpDetailScreen = () => {
    return (
        <SafeAreaView style={styles.background}>
            <Text style={[styles.title, typoStyles.fs32, typoStyles.fwBold, typoStyles.textMain]}>이용약관</Text>
            <View style={styles.detailbox}>
                <ScrollView>
                <Text style={[typoStyles.fs12, typoStyles.fwRegular, typoStyles.textExplain]}> 
...
서로가 고통을 덜어 주지 않는다면 우리는 무엇을 위해 사는 것일
...
참된 우정은 건강과 같아서 그것을 잃어버려야만 그 가치가 드러
