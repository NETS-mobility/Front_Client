...
const pickCategory = (data, dispatch, pick) => {
  const categories = {
    ...
    13: ['차량 번호 2', dispatch?.[0]?.car_number],
    14: ['네츠 매니저 1', dispatch?.[0]?.netsmanager_name],
    15: ['네츠 매니저 2', dispatch?.[0]?.netsmanager_name],
  };
